...
class TestTimeParsingFunctionality:
    ...
    def test_dry_run_flag_set_correctly(self):
        ...
        changer_normal = MetadataTimeChanger(str(self.test_directory), "+5", dry_run=False)
...
class TestTimeAdjustmentFunctionality:
    ...
    def test_adjust_timestamps_positive_adjustment(self):
        ...
        assert adjusted_timestamps['DateTimeOriginal'] == datetime(2023, 12, 30, 14, 30, 45)
    ...
    def test_adjust_timestamps_negative_adjustment(self):
        ...
        assert adjusted_timestamps['modification_time'] == datetime(2023, 12, 15, 16, 0, 0)
    ...
    def test_set_file_system_timestamps_uses_modification_time_priority(self):
        ...
        timestamps = {
            ...
            'creation_time': datetime(2023, 12, 26, 16, 0, 0)  # Different time, should be ignored
        }
    ...
    def test_adjust_timestamps_handles_none_values(self):
        ...
        assert adjusted_timestamps['DateTimeOriginal'] == datetime(2023, 12, 26, 14, 30, 45)
...
class TestIntegrationFunctionality:
    ...
    def test_process_mixed_media_directory_dry_run(self):
        ...
        assert all(result['filesystem_updated'] for result in results)  # All should update filesystem
        
        # Check file types are correctly identified
        image_files = [f for f in media_files if f.suffix.lower() in changer.IMAGE_EXTENSIONS]
        video_files = [f for f in media_files if f.suffix.lower() in changer.VIDEO_EXTENSIONS]
    ...
    def test_time_adjustment_consistency_across_file_types(self):
        ...
        for file_path in media_files:
            ...
            original_mtime = result['original_timestamps']['filesystem']['modification_time']
            adjusted_mtime = result['adjusted_timestamps']['filesystem']['modification_time']
